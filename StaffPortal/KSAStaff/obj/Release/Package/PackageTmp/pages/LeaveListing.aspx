<%@ Page Title="Leave Listing" Language="C#" MasterPageFile="~/Layouts/Main.Master" AutoEventWireup="true" CodeBehind="LeaveListing.aspx.cs" Inherits="KSAStaff.pages.LeaveListing" %>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="box box-info">
                        ...
                        <div class="box-body">
                            <div class="col-md-12">
                                <p class="text-center"><a class="btn btn-pill btn-info u-posRelative pull-left" href="LeaveApplication.aspx?query=new&status=Open">Apply For Leave<span class="waves"></span> </a></p>
