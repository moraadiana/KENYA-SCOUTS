<%@ Page Title="Imprest Accounting Lines" Language="C#" MasterPageFile="~/Layouts/Main.Master" AutoEventWireup="true" CodeBehind="ImprestAccountingLines.aspx.cs" Inherits="KSAStaff.pages.ImprestAccountingLines" %>
                ...
                <div class="col-md-12">
                    <div class="box box-warning box-solid">
                        ...
                        <div class="box-body">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <a href="ImprestAccountingList.aspx" class="btn btn-warning pull-left"><i class="fa fa-backward"></i>&nbsp;Back</a>
